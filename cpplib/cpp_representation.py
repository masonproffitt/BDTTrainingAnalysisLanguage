...
class cpp_value(cpp_rep_base):
    ...
    '''
    def __init__(self, cpp_expression: str, scope: gc_scope, cpp_type):
        r'''
...
class cpp_variable(cpp_value):
    ...
    '''
    def __init__(self, cpp_expression: str, scope: gc_scope, cpp_type, initial_value: cpp_value=None):
...
class cpp_tuple(cpp_rep_base):
    ...
    '''
    def __init__(self, list_of_values: tuple, scope: gc_scope):
        '''
...
class cpp_sequence(cpp_rep_base):
    ...
    '''
    def __init__ (self, sequence_value: cpp_value, iterator_value: cpp_value):
        '''
        Create a sequence
